...
def usuario_cadastrado(sender, instance, created, **kwargs):
    if created:
        ...
        email_remetente = 'eduardobusato51@gmail.com'
...
def diarista_selecionada(sender, instance, **kwargs):
    if instance.status == 3:
        html_message_cliente = render_to_string("email_diarista_selecionada.html", {"usuario":instance.cliente, "diaria":instance})
        html_message_diarista = render_to_string("email_diarista_selecionada.html", {"usuario":instance.diarista, "diaria":instance})
        email_remetente = "eduardobusato51@gmail.com"
