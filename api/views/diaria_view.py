...
class Diaria(APIView):
    ...
    @swagger_auto_schema(responses={200: diaria_serializer.DiariaSerializer()})
    ...
    @swagger_auto_schema(responses={201: diaria_serializer.DiariaSerializer()}, request_body=diaria_serializer.DiariaSerializer)
